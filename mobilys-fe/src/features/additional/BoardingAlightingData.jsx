...
import { useBoardingAlightingData } from "./hooks/useBoardingAlightingData";
...
export default function BoardingAlightingData({ embedded = false }) {
  const ui = RIDERSHIP.boardingAlighting;
  const {
    scenarioOptions,
    scenarioId,
    setScenarioId,
      ...
      >
        ...
        >
          ...
          <FormControl sx={{ minWidth: 280 }} disabled={scenarioLoading}>
            <InputLabel id="boarding-alighting-scenario-select">{ui.scenarioSelect.label}</InputLabel>
            <Select
              labelId="boarding-alighting-scenario-select"
              value={scenarioId}
